...
export default function CancellationsPage() {
  ...
  const columns = [
    ...
    { key: "action", type: "action", onClick: (item) => alert(`View ${item.id}`), label: "View Details" },
  ];

  return <TableCard title="My Cancellations" data={cancellations} columns={columns} statusStyles={statusStyles} />;
}
