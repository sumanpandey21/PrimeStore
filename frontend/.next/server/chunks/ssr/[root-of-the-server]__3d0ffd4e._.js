...
"[project]/src/app/myaccount/layout.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AccountLayout({ children }) {
    ...
    const linkClass = (path)=>`block w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors ${pathname === path ? "text-orange-600 bg-orange-50" : "text-gray-700 hover:text-orange-600 hover:bg-gray-50"}`;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchData() {
            try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d0ffd4e._.js.map