...
const page = ()=>{
    ...
    const [lastLoginErrorMessage, setLastLoginErrorMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
        ...
        "page.useEffect": ()=>{
            ...
            if (cooldownSeconds > 0) {
                timer = setTimeout({
                    "page.useEffect": ()=>{
                        setCooldownSeconds({
                            "page.useEffect": (prevSeconds)=>prevSeconds - 1
                        }["page.useEffect"]);
                    }
                }["page.useEffect"], 1000);
            }
    ...
    const handleSubmit = async (e)=>{
        ...
        if (validateForm()) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (data && data.detail) {
                        ...
                        errorMessage = "Email error: ".concat(data.email.join(', '));
                    } else if (data && data.password) {
                        errorMessage = "Password error: ".concat(data.password.join(', '));
                    }
                    if (shouldShowResendLink(errorMessage)) {
                        setLastLoginErrorMessage(errorMessage);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warn(errorMessage + ' Please check your email to verify your account.', {
                            position: "bottom-right"
                        });
                    } else {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('A network error occurred. Please try again later.', {
                    position: "bottom-right"
                });
            } finally{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Please correct the errors in the form.', {
                position: "bottom-right"
            });
            setIsLoggingIn(false);
        }
    ...
    const handleResendVerification = async (e)=>{
        e.preventDefault();
        if (!formData.email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Please enter your email in the field above to resend the verification link.', {
                position: "bottom-right"
            });
            return;
        }
        if (cooldownSeconds > 0) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Please wait ".concat(cooldownSeconds, " seconds before resending again."), {
                position: "bottom-right"
            });
            return;
        }
        ...
        try {
            ...
            const data = await response.json();
            if (response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(/*data.detail || */ 'New verification email sent! Please check your inbox.', {
                    position: "bottom-right"
                });
            } else {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('A network error occurred while trying to resend the email.', {
                position: "bottom-right"
            });
    ...
    const handleGoogleLogin = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Google login integration coming soon!', {
            position: "bottom-right"
        });
    };
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        className: "w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800 placeholder-gray-500 ".concat(errors.email ? 'border-red-500' : 'border-gray-300'),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        onChange: handleChange,
                                        className: "w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800 placeholder-gray-500 ".concat(errors.password ? 'border-red-500' : 'border-gray-300'),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-right text-sm mt-2 flex items-center ".concat(shouldShowResendLink(lastLoginErrorMessage) ? 'justify-between' : 'justify-end'),
                                        children: [
                                            shouldShowResendLink(lastLoginErrorMessage) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                href: "#",
                                                onClick: handleResendVerification,
                                                // Disable if currently resending or if cooldown is active
                                                className: "text-blue-600 hover:underline mr-4 ".concat(isResending || cooldownSeconds > 0 ? 'opacity-50 cursor-not-allowed' : ''),
                                                disabled: isResending || cooldownSeconds > 0,
                                                children: isResending ? 'Sending...' : cooldownSeconds > 0 ? "Resend in ".concat(cooldownSeconds, "s") : 'Resend Verification Link'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/login/page.js",
                                                lineNumber: 225,
                                                columnNumber: 17
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                        href: "https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GOOGLE_REDIRECT_URI, "&prompt=consent&response_type=code&client_id=").concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GOOGLE_CLIENT_ID, "&scope=openid%20email%20profile&access_type=offline"),
...
_s(page, "2VXQOc37DG7K7wlYi41ucW0QRS0=", false, function() {
    return [
...
//# sourceMappingURL=_64030d5d._.js.map